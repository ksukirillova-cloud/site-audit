...
<div style={{
  background: "linear-gradient(135deg, #1B63FF 0%, #1045CC 100%)",
  borderRadius: 20,
  padding: "28px 26px",
  marginBottom: 20,
  boxShadow: "0 12px 40px rgba(27,99,255,0.28)",
}}>
  <p style={{ fontSize: 11, fontWeight: 800, textTransform: "uppercase",
    letterSpacing: "0.1em", color: "rgba(255,255,255,0.55)", marginBottom: 8 }}>
    следующий шаг
  </p>
  <h3 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 20,
    fontWeight: 900, color: "#fff", marginBottom: 10, letterSpacing: "-0.02em" }}>
    Сохрани результаты и получи чек-лист
  </h3>
  <p style={{ fontSize: 14, color: "rgba(255,255,255,0.72)",
    lineHeight: 1.6, marginBottom: 20 }}>
    Нажми кнопку — бот отправит PDF-чек-лист «20 точек, где сайт теряет клиентов». Бесплатно, в Telegram. И у тебя останется контакт для следующего шага.
  </p>
  <a href={CHECKLIST_BOT_URL} target="_blank" rel="noreferrer"
    style={{
      display: "inline-flex", alignItems: "center", gap: 8,
      background: "#C8FF3D", color: "#000", borderRadius: 12,
      padding: "12px 22px", fontSize: 14, fontWeight: 800,
      textDecoration: "none", boxShadow: "0 4px 16px rgba(200,255,61,0.3)",
    }}>
